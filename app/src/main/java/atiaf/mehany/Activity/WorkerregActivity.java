...
public class WorkerregActivity extends Activity {
    TextView back ;
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (fna.equals("") || lna.equals("") || use.equals("") || em.equals("") || ph.equals("") || pass.equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(),WorkercompleteActivity.class);
                    startActivity(i);
                }
            }
        });
...
//                        userId=obj.getString("id");
                    ...
                    ArrayAdapter<Country> adapter = new ArrayAdapter<Country>(WorkerregActivity.this, android.R.layout.simple_spinner_dropdown_item, countries) {
