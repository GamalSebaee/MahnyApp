...
public class TeacherperviousorderActivity extends Activity {
    TextView back;
    RecyclerView list ;
    ...
    public void loaddata(){
        final ProgressDialog progressDialog = ProgressDialog.show(TeacherperviousorderActivity.this, getString(R.string.wait), getString(R.string.che), true);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_teacher + "get_all_call_ended", new Response.Listener<String>() {
            @Override
