...
public class ProviderseettingActivity extends Activity {
    ...
    public void loaddata() {
        final ProgressDialog progressDialog = ProgressDialog.show(ProviderseettingActivity.this, getString(R.string.wait), getString(R.string.che), true);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_worker + "get_offer_charge", new Response.Listener<String>() {
            @Override
