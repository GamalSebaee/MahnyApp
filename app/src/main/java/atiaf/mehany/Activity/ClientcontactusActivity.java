...
public class ClientcontactusActivity extends Activity {
    TextView back;
...
String ph = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(ClientcontactusActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void getinformaion() {
        final ProgressDialog progressDialog = ProgressDialog.show(ClientcontactusActivity.this, getString(R.string.wait), getString(R.string.che), true);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url + "get_contact", new Response.Listener<String>() {
            @Override
...
ph = obj.getJSONObject("data").getString("phone");
