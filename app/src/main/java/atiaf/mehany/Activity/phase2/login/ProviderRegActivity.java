...
public class ProviderRegActivity extends Activity {
    ...
    public static String fna = "", lna = "" ,em = "", ph = "", pass = "", cityid = "" , ha = "" , repeat = "" , use = "" , file = "" , country_id = "";    @Override
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (fna.equals("") || lna.equals("") || use.equals("") || em.equals("") || ph.equals("") || pass.equals("")) {
                    ...
                    Intent i = new Intent(getApplicationContext(),ProviderCompleteRegActivity.class);
                    startActivity(i);
                }
            }
        });
...
//                        userId=obj.getString("id");
                    ...
                    ArrayAdapter<Country> adapter = new ArrayAdapter<Country>(ProviderRegActivity.this, android.R.layout.simple_spinner_dropdown_item, countries) {
