...
public class ClientaboutappActivity extends Activity {
    TextView back ;
    ...
    public void getinformaion() {
        final ProgressDialog progressDialog = ProgressDialog.show(ClientaboutappActivity.this, getString(R.string.wait), getString(R.string.che), true);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url + "get_about", new Response.Listener<String>() {
            @Override
