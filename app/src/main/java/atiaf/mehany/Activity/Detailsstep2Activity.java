...
public class Detailsstep2Activity extends Activity {
    TextView back;
    TextViewWithFont ordernum , title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailsstep2);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(Detailsstep2Activity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void loaddata(){
        final ProgressDialog progressDialog = ProgressDialog.show(Detailsstep2Activity.this, getString(R.string.wait), getString(R.string.che), true);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url + "get_all_action", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Picasso.with(Detailsstep2Activity.this).load(jo.getString("img")).into(img, new Callback() {
                        @Override
