...
public class WorkercontactusActivity extends Activity {
    ...
    public void getinformaion() {
        final ProgressDialog progressDialog = ProgressDialog.show(WorkercontactusActivity.this, getString(R.string.wait), getString(R.string.che), true);
