...
//            Log.i(TAG, "Location services connection failed with code " + connectionResult.getErrorCode());
    ...
    public void loaddata(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_worker + "get_all_call_currant", new Response.Listener<String>() {
            @Override
...
//                        charge.status = jo.getString("status");
                        ...
                        details1.setText(jo.getString("order_details"));
                        sertype1.setText(jo.getString("title_job"));
...
// Make marker on the current location
//                        BitmapDescriptor map_client = BitmapDescriptorFactory.fromResource(R.drawable.marker_map2);
//                        MarkerOptions options = new MarkerOptions()
//                                .position(latLn)
//                                .icon(map_client)
//                                .title("my location");
...
//
//                        mMap.addMarker(options);
//                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latLn, 10));
// move the camera zoom to the location
    ...
    public void makeaction(String url ){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_worker+url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
