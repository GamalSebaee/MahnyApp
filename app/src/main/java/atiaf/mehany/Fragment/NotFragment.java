...
import atiaf.mehany.Adapter.Worknotdapter;
...
public class NotFragment extends Fragment {
    RecyclerView list ;
    public static Worknotdapter productadapter ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (v==null){
            ...
            productadapter = new Worknotdapter(appsdep);
    ...
    public void loaddata(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_worker + "get_all_Noti", new Response.Listener<String>() {
            @Override
