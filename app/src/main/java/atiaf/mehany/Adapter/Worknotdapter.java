...
import atiaf.mehany.Activity.WorkernotdetialsActivity;
 ...
 */
public class Worknotdapter extends RecyclerView.Adapter<Worknotdapter.MyViewHolder> {
    ...
    public Worknotdapter(List<Not> horizontalList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.worknot, parent, false);
...
// move the camera zoom to the location
        ...
        holder.lin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context , WorkernotdetialsActivity.class);
    ...
    public void start_order(final String id , final int pos , final String user_id){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Gdata.url_worker+"start_order", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("Success")){
                        NotFragment.appsdep.remove(pos);
                        NotFragment.productadapter.notifyDataSetChanged();
                        Intent i = new Intent(context , WorkertabActivity.class);
